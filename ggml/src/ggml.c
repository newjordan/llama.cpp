...
void ggml_flash_attn_ext_set_kv_idxs(
        struct ggml_tensor * a,
    ...
    GGML_ASSERT(kv_idxs->ne[0] == a->src[1]->ne[1]);
    GGML_ASSERT(kv_idxs->ne[1] == a->src[1]->ne[3]);
    GGML_ASSERT(kv_idxs->ne[2] == 1);
    GGML_ASSERT(kv_idxs->ne[3] == 1);
