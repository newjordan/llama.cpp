...
# Treebeard SYCL op profiler (legacy env TREEBEARD_WAVEFRONT_SIQ_PROF still accepted)
TREEBEARD_SYCL_PROF=${TREEBEARD_WAVEFRONT_SYCL_PROF:-${TREEBEARD_WAVEFRONT_SIQ_PROF:-0}}
...
if [[ "$TREEBEARD_SYCL_PROF" == 1 ]]; then
    mode_env+=(TREEBEARD_SYCL_PROF=1)
fi
